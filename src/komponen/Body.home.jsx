          ...
          <FeaturedText>
            ...
            >
              <SocialIcons className="social_icons">
                <Icon className="icon">
                  <Link to="https://www.instagram.com/gahleh_gp/" target="_blank">
                    <i className="uil uil-instagram"></i>
                  </Link>
                </Icon>
                <Icon className="icon">
                  <Link
                    to="https://www.linkedin.com/in/gahleh-pamungkas-a8916721a/"
                    target="_blank">
                    <i className="uil uil-linkedin-alt"></i>
                  </Link>
                </Icon>
                <Icon className="icon">
                  <Link to="https://github.com/0xahleh" target="_blank">
